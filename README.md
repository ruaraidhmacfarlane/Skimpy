...
![Running Skimpy](https://cloud.githubusercontent.com/assets/8971646/12394952/bdae6da8-bdf6-11e5-8bbe-4412d5d04dfd.png)
  ...
  i.   Pressing "a" will initialise the database. This means there will be no products or users in any tables.

  ii.  Pressing "b" will open a sub-menu for initializing an individual table, deleting its contents.

  iii. Pressing "c" will open a sub-menu for populating individual tables with test data.

  iv.  Pressing "d" will open a sub-menu for running one of the web scrapers.

  v.   Pressing "q" will quit the menu.
